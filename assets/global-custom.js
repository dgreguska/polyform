...
/***/ "./src/components/global-custom/gallery_modal/js/gallery_modal.js":
/*!************************************************************************!*\
  !*** ./src/components/global-custom/gallery_modal/js/gallery_modal.js ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var GalleryModal = /*#__PURE__*/function () {
  ...
  _createClass(GalleryModal, [{
    ...
    value: function initGlide(slickOptions, slideId) {
      ...
      this.glide = new _glidejs_glide__WEBPACK_IMPORTED_MODULE_0__["default"](this.modalEl.querySelector(this.selectors.glide), _objectSpread(_objectSpread({}, slickOptions), {}, {
        startAt: slideId
      }));
      ...
      this.glide.on('run.after', function (e) {
        ...
        (_this2$modalEl$queryS = _this2.modalEl.querySelector("".concat(_this2.selectors.zoom).concat(_this2.selectors.zoomActive))) === null || _this2$modalEl$queryS === void 0 ? void 0 : _this2$modalEl$queryS.classList.remove(_this2.classes.zoomActive);
      });
      this.glide.mount();
    }
  }, {
    ...
    value: function setNavigationItemActive(slideId) {
      ...
      (_this$modalEl$querySe = this.modalEl.querySelector("".concat(this.selectors.thumbnail).concat(this.selectors.thumbnailActive))) === null || _this$modalEl$querySe === void 0 ? void 0 : _this$modalEl$querySe.classList.remove(this.classes.thumbnailActive);
      (_this$modalEl$querySe2 = this.modalEl.querySelector("".concat(this.selectors.thumbnail, "[data-slide-id=\"").concat(slideId, "\"]"))) === null || _this$modalEl$querySe2 === void 0 ? void 0 : _this$modalEl$querySe2.classList.add(this.classes.thumbnailActive);
    }
  }, {
    key: "zoomToggle",
...
/***/ "./src/components/global-custom/gallery_modal/js/main.js":
/*!***************************************************************!*\
  !*** ./src/components/global-custom/gallery_modal/js/main.js ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/components/global-custom/generic_slider/js/generic_slider.js":
/*!**************************************************************************!*\
  !*** ./src/components/global-custom/generic_slider/js/generic_slider.js ***!
  \**************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    value: function handleIntersection(entries) {
      ...
      entries.forEach(function (entry) {
        if (entry.isIntersecting) {
          if (entry.target.classList.contains('glide--carousel')) {
            return;
          }
...
/***/ "./src/components/global-custom/generic_slider/js/main.js":
/*!****************************************************************!*\
  !*** ./src/components/global-custom/generic_slider/js/main.js ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
document.addEventListener('shopify:section:load', function (event) {
  var slider = event.target.classList.contains('slideshow');
  if (!slider) return;
  new window.SBGenericSlider('[data-generic-slider]');
});
...
/***/ "./src/components/global-custom/js/global.js":
/*!***************************************************!*\
  !*** ./src/components/global-custom/js/global.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Global = /*#__PURE__*/function () {
  function Global() {
    ...
    window.addEventListener("DOMContentLoaded", function () {
      ...
      if (typeof stickyHeader != 'undefined' && stickyHeader != null && window.location.pathname === "/") {
  ...
  _createClass(Global, [{
    ...
    value: function initStickyHeader(header) {
      ...
      if (document.querySelector('.main-header').classList.contains('light')) {
        isLight = true;
      }
    ...
    value: function initSidebars() {
      ...
      toggle.forEach(function (el) {
        el.addEventListener('click', function (e) {
          var toggleEl = e.target.closest('.js-sidebar-toggle');

          if (toggleEl.dataset.sidebarTarget) {
            var sidebar = document.getElementById(toggleEl.dataset.sidebarTarget);

            if (sidebarActive) {
              document.querySelector('html').classList.remove(_this3.noScrollClass);
              document.querySelector('body').classList.remove(_this3.noScrollClass);
              sidebar.classList.remove('active');
            } else {
              document.querySelector('html').classList.add(_this3.noScrollClass);
              document.querySelector('body').classList.add(_this3.noScrollClass);
    ...
    value: function initHeaders() {
      window.LS_COMPARATOR_KEY = "comparator_objects";
      ...
      window.SBFetchHeadersFnc = function () {
        return new Headers({
      ...
      window.SBFetchHeaders = window.SBFetchHeadersFnc();

      window.SBJSONFetchHeadersFnc = function () {
        return new Headers({
      ...
      window.SBJSONFetchHeaders = window.SBJSONFetchHeadersFnc();
...
/***/ "./node_modules/bootstrap5/js/dist/base-component.js":
/*!***********************************************************!*\
  !*** ./node_modules/bootstrap5/js/dist/base-component.js ***!
  \***********************************************************/
...
/***/ "./node_modules/bootstrap5/js/dist/collapse.js":
/*!*****************************************************!*\
  !*** ./node_modules/bootstrap5/js/dist/collapse.js ***!
  \*****************************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
...
/***/ "./node_modules/bootstrap5/js/dist/dom/data.js":
/*!*****************************************************!*\
  !*** ./node_modules/bootstrap5/js/dist/dom/data.js ***!
  \*****************************************************/
/***/ (function(module) {
...
/***/ "./node_modules/bootstrap5/js/dist/dom/event-handler.js":
/*!**************************************************************!*\
  !*** ./node_modules/bootstrap5/js/dist/dom/event-handler.js ***!
  \**************************************************************/
/***/ (function(module) {
...
/***/ "./node_modules/bootstrap5/js/dist/dom/manipulator.js":
/*!************************************************************!*\
  !*** ./node_modules/bootstrap5/js/dist/dom/manipulator.js ***!
  \************************************************************/
/***/ (function(module) {
...
/***/ "./node_modules/bootstrap5/js/dist/dom/selector-engine.js":
/*!****************************************************************!*\
  !*** ./node_modules/bootstrap5/js/dist/dom/selector-engine.js ***!
  \****************************************************************/
/***/ (function(module) {
...
/***/ "./node_modules/bootstrap5/js/dist/dropdown.js":
/*!*****************************************************!*\
  !*** ./node_modules/bootstrap5/js/dist/dropdown.js ***!
  \*****************************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
...
/***/ "./node_modules/bootstrap5/js/dist/modal.js":
/*!**************************************************!*\
  !*** ./node_modules/bootstrap5/js/dist/modal.js ***!
  \**************************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
...
/***/ "./node_modules/bootstrap5/js/dist/tab.js":
/*!************************************************!*\
  !*** ./node_modules/bootstrap5/js/dist/tab.js ***!
  \************************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
...
/***/ "./node_modules/bootstrap5/js/dist/tooltip.js":
/*!****************************************************!*\
  !*** ./node_modules/bootstrap5/js/dist/tooltip.js ***!
  \****************************************************/
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {
...
"use strict";
/*!*************************************************!*\
  !*** ./src/components/global-custom/js/main.js ***!
  \*************************************************/
__webpack_require__.r(__webpack_exports__);
...
/******/ })()
;
//# sourceMappingURL=global-custom.js.map