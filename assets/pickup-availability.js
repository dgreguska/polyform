...
if (!customElements.get('pickup-availability-drawer')) {
  customElements.define('pickup-availability-drawer', class PickupAvailabilityDrawer extends HTMLElement {
    ...
    hide() {
      ...
      document.querySelector('.js-background-filter').classList.add('opacity-0', 'invisible')
    ...
    show(focusElement) {
      ...
      document.querySelector('.js-background-filter').classList.remove('opacity-0', 'invisible');
      trapFocus(this);
    }
  });
}
